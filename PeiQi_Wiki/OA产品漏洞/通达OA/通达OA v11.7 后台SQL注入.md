...
![](http://wikioss.peiqi.tech/vuln/tongdaoa-3.png)
...
![](http://wikioss.peiqi.tech/vuln/tongdaoa-4.png)

使用盲注对SQL注入进行测试

![](http://wikioss.peiqi.tech/vuln/tongdaoa-5.png)

触发了通达OA的SQL注入拦截

**inc/conn.php**文件中找到过滤机制如下:

![](http://wikioss.peiqi.tech/vuln/tongdaoa-6.png)
...
![](http://wikioss.peiqi.tech/vuln/tongdaoa-7.png)

![](http://wikioss.peiqi.tech/vuln/tongdaoa-8.png)
...
![](http://wikioss.peiqi.tech/vuln/tongdaoa-9.png)
...
![](http://wikioss.peiqi.tech/vuln/tongdaoa-12.png)
