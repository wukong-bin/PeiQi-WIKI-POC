...
![](http://wikioss.peiqi.tech/vuln/ruoyi-1.png)

访问后会下载文件 **/etc/passwd**

![](http://wikioss.peiqi.tech/vuln/ruoyi-2.png)

可以使用Burp抓包改变 **/etc/passwd** 为其他文件路径获取敏感信息

![](http://wikioss.peiqi.tech/vuln/ruoyi-4.png)

![](http://wikioss.peiqi.tech/vuln/ruoyi-5.png)

在新版本的修复中添加了过滤

![](http://wikioss.peiqi.tech/vuln/ruoyi-7.png)
...
![](http://wikioss.peiqi.tech/vuln/ruoyi-6.png)
