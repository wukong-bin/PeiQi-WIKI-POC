...
![](http://wikioss.peiqi.tech/vuln/jump-1.png)

**资产管理 --> 管理用户**

![](http://wikioss.peiqi.tech/vuln/jump-2.png)

**用户管理 --> 用户列表**

![](http://wikioss.peiqi.tech/vuln/jump-3.png)

**资产管理 --> 资产列表**

![](http://wikioss.peiqi.tech/vuln/jump-4.png)

查看一下项目代码提交变动

![](http://wikioss.peiqi.tech/vuln/jump-5.png)
...
![](http://wikioss.peiqi.tech/vuln/jump-6.png)

比如send这里获取的 Task id ,这里是可以获得一些敏感的信息的

![](http://wikioss.peiqi.tech/vuln/jump-7.png)



查看一下连接Web终端的后端api代码

![](http://wikioss.peiqi.tech/vuln/jump-8.png)

可以看到这里调用时必须需要 **user asset system_user** 这三个值，再获取一个20秒的 **token**

访问web终端后查看日志的调用

![](http://wikioss.peiqi.tech/vuln/jump-9.png)
...
![](http://wikioss.peiqi.tech/vuln/jump-10.png)
...
![](http://wikioss.peiqi.tech/vuln/jump-18.png)

发送请求获取20s的token

![](http://wikioss.peiqi.tech/vuln/jump-11.png)

看一下 koko.js 这个前端文件

![](http://wikioss.peiqi.tech/vuln/jump-12.png)

后端代码 https://github.com/jumpserver/koko/blob/e054394ffd13ac7c71a4ac980340749d9548f5e1/pkg/httpd/webserver.go

![](http://wikioss.peiqi.tech/vuln/jump-13.png)

这里我们就可以通过 获得的token来模拟请求

![](http://wikioss.peiqi.tech/vuln/jump-14.png)

成功连接模拟了这个 token 的请求,可以在Network看一下流量是怎么发送的

![](http://wikioss.peiqi.tech/vuln/jump-15.png)

模拟连接发送和接发数据

![](http://wikioss.peiqi.tech/vuln/jump-16.png)
...
![](http://wikioss.peiqi.tech/vuln/jump-19.png)

![](http://wikioss.peiqi.tech/vuln/jump-20.png)
