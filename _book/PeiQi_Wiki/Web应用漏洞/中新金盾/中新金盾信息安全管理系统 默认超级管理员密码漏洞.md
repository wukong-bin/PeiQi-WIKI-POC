...
![](http://wikioss.peiqi.tech/vuln/zxjd-2.png)

系统默认管理员账号密码：

**admin/zxsoft1234!@#$**

![](http://wikioss.peiqi.tech/vuln/zxjd-1.png)

登录页面如上，使用账号密码登录

其中泄露了大部分信息，其中包括 SMMS与FTP 及用户信息

![](http://wikioss.peiqi.tech/vuln/zxjd-3.png)

![](http://wikioss.peiqi.tech/vuln/zxjd-4.png)
...
![](http://wikioss.peiqi.tech/vuln/zxjd-6.png)
...
![](http://wikioss.peiqi.tech/vuln/zxjd-5.png)
...
![](http://wikioss.peiqi.tech/vuln/zxjd-7.png)
